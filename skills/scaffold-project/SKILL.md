...
.PHONY: help goimports fmt vet lint gocyclo govulncheck shellcheck unit unit-update-golden integration static
```
...
.PHONY: help fmt fmt-check clippy dead-code audit shellcheck unit unit-update-golden integration static
```
